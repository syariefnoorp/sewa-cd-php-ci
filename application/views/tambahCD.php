        ...
        <center>
            <div style="display: inline-block">
                <div>
                    ...
                    <div>
                        <h3 class="subhead">Tambah CD</h3>
                    </div>
                    <div>
                        <form action="<?php echo base_url() ?>index.php/Admin_controller/tambahCD" method="POST">
                            <div>
                            ...
                            <div>
                                ...
                                <input class="btnDaftar" type="submit" name="submit" value="Tambah">
                            </div>
                        </form>
                    </div>
                </div>
